...
###
Le modèle traditionnel de sécurité périmétrique (« château fort ») est devenu insuffisant avec la généralisation du Cloud et du travail hybride. 
Le ZTNA repose sur un principe simple : « ne jamais faire confiance, toujours vérifier ». Contrairement au VPN classique, 
il n'accorde l'accès qu'après une vérification stricte de l'identité de l'utilisateur et de l'état de son appareil, 
quel que soit l'endroit où il se trouve. En tant qu'étudiant en SISR, 
